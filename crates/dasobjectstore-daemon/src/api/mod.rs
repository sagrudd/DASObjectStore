...
pub use profile_s3::{
    ...
    ProfileS3MultipartPartRequest, ProfileS3MultipartReceiptView, ProfileS3MultipartStatusRequest,
    ProfileS3MultipartStatusResponse, ProfileS3MultipartUploadView,
    ProfileS3MultipartUploadsRequest, ProfileS3MultipartUploadsResponse, ProfileS3ObjectView,
    ProfileS3VerifyRequest, ProfileS3VerifyResponse, PROFILE_S3_DELETE_ROUTE,
    PROFILE_S3_HEALTH_ROUTE, PROFILE_S3_MAX_KEYS, PROFILE_S3_MAX_MULTIPART_PARTS,
    PROFILE_S3_MULTIPART_COMPLETE_ROUTE, PROFILE_S3_MULTIPART_PART_ROUTE, PROFILE_S3_OBJECTS_ROUTE,
...
pub use remote_easyconnect::{
    ...
    RemoteEasyconnectValidationError, REMOTE_CLIENT_PROTOCOL_MAX, REMOTE_CLIENT_PROTOCOL_MIN,
    REMOTE_EASYCONNECT_DEFAULT_CONTROL_PREFIX, REMOTE_EASYCONNECT_DEFAULT_SESSION_LIFETIME_SECONDS,
...
pub enum DaemonApiRequest {
    ...
    ProfileS3MultipartStatus(ProfileS3MultipartStatusRequest),
    ProfileS3MultipartUploads(ProfileS3MultipartUploadsRequest),
...
impl DaemonApiRequest {
    pub(crate) fn command_name(&self) -> &'static str {
        match self {
            ...
            Self::ProfileS3MultipartStatus(_) => "profile_s3_multipart_status",
            Self::ProfileS3MultipartUploads(_) => "profile_s3_multipart_uploads",
    ...
    pub fn validate(&self) -> Result<(), DaemonRequestValidationError> {
        match self {
            ...
            Self::ProfileS3MultipartStatus(request) => request.validate(),
            Self::ProfileS3MultipartUploads(request) => request.validate(),
...
pub enum DaemonApiResponse {
    ...
    ProfileS3MultipartStatus(ProfileS3MultipartStatusResponse),
    ProfileS3MultipartUploads(ProfileS3MultipartUploadsResponse),
