...
pub use profile_s3::{
    ...
    ProfileS3MultipartPartRequest, ProfileS3MultipartUploadView, ProfileS3MultipartUploadsRequest,
    ProfileS3MultipartUploadsResponse, ProfileS3ObjectView, ProfileS3VerifyRequest,
