...
use crate::runtime::{
    ...
    upsert_application_identity, upsert_endpoint_inventory_record, upsert_profile_binding,
...
mod tests {
    ...
    use crate::api::{
        ...
        ApplicationIdentityRegistrationRequest, AssignLocalUserToLocalGroupRequest,
