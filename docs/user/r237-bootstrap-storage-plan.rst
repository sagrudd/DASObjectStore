...
descriptor-relative, no-follow verification of every root-owned, non-writable
ancestor directory and the final regular executable, and executes with a
cleared, minimal environment. A missing, symlinked, writable, or otherwise
untrusted tool leaves the related proof unavailable.
