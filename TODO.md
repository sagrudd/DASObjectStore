...
- [ ] Replace the transitional Web configure planner with an authenticated Web action that forwards the logged-in local administrator identity through the daemon boundary; keep policy inspection available without exposing registry files.
