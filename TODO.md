...
- [ ] Expose the policy API through an authenticated `dasobjectstore store policy`/Web action and reject requests whose administrator identity is not established by the daemon's local authorization boundary.
