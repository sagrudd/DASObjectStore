...
- [ ] Enrich the preflight event with authoritative mount point, filesystem, and backing-device identifiers from daemon source classification, including an explicit unavailable/unknown value when topology verification cannot resolve them.
