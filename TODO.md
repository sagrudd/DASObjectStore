...
- [ ] Reconcile the Web service peer's daemon group membership in packaged deployments so the daemon can verify the authenticated Web administrator without trusting a browser-supplied identity.
