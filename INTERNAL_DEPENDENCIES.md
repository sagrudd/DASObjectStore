...
| --- | --- | --- | --- | --- |
| `../prosopikon` | Identity contracts and Yew components. Patched by `Cargo.toml`; package preflight is `packaging/pinned-mnemosyne-package-sources.sh`. | `c4055d07c3d8715cd01d13775d1a51d529be64e7` (detached package checkout) | `https://github.com/sagrudd/prosopikon.git` | Primary checkout: `main` at `206ff7cec384062217cdc7401ab43c0f8c11ea23`, dirty/unsafe for release packaging. |
